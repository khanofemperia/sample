    ...
    <>
      <nav className="w-full max-h-[116px] md:max-h-16 border-b bg-white">
        <div className="w-full max-w-5xl mx-auto px-6 py-2 relative flex gap-1 flex-col md:flex-row">
          ...
          <div
            className={`w-full hidden md:block ${clsx({
              hidden: isSearchVisible,
            })}`}
          >
            <div className="w-full flex items-center justify-center md:pl-6 lg:pl-0 overflow-hidden">
              ...
              >
                <Image
                  ...
                  priority
                />
                <span className="lg:hidden font-medium text-neutral-500">
                  Browse the store
                </span>
                <span className="hidden lg:block font-medium text-neutral-500">
      ...
      {isSearchVisible && (
        <div className="w-full h-screen fixed top-0 z-10 bg-white bg-opacity-60 backdrop-blur-md transition duration-300 ease-in-out"></div>
      )}
    </>
  );
}
