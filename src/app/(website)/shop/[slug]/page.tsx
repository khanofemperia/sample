...
export default function ProductDetails({
  ...
  return (
    ...
    //                       <span className="line-through text-gray">$79.99</span>
    //                     </p>
    //                   </li>
    //                   <li>
    ...
    //                       <span className="line-through text-gray">$99.99</span>
    //                     </p>
    //                   </li>
    //                   <li>
    ...
    //                       <span className="line-through text-gray">$69.99</span>
    //                     </p>
    //                   </li>
    //                   <li>
    ...
    <>
      <main>
        <div className="w-full h-[1200px]">
          ...
          <div className="fixed left-0 right-0 bottom-0 z-10 pt-2 pb-5 px-[6px] min-[350px]:px-2 border-r bg-white">
